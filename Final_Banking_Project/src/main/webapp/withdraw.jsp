...
<head>
    ...
    <title>AuraBank - Withdraw Funds</title>
            ...
            <form action="withdraw" method="post">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                         <span class="input-group-text" style="background-color: var(--dark-bg); border-color: var(--border-color); color: var(--muted-color);">$</span>
                ...
                <div class="d-grid">
                    <button type="submit" class="btn btn-warning btn-submit">
                        <i class="bi bi-cash-coin me-2"></i>Confirm Withdrawal
                    </button>
                </div>
            </form>
        </div>
