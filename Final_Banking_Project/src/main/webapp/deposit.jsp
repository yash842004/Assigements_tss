...
<title>AuraBank - Deposit Funds</title>
	...
	<div class="main-content">
		...
		<div class="form-section">
			...
			<form action="deposit" method="post">
				<div class="mb-4">
					<label for="accountId" class="form-label">Select Account</label> <select
						id="accountId" name="accountId" class="form-select" required>
						<c:forEach var="acc" items="${accounts}">
							<option value="${acc.accountId}">${acc.accountType}-
				...
				<div class="mb-4">
					...
					<div class="input-group">
						<span class="input-group-text"
							style="background-color: var(--dark-bg); border-color: var(--border-color); color: var(--muted-color);">$</span>
