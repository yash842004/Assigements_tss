...
public class LoanScheduledTaskService {
    ...
    /**
     * Process automatic EMI deductions daily at 9:00 AM
     */
    ...
    /**
     * Process overdue loans and apply late fees daily at 10:00 AM
     */
    ...
    /**
     * Generate overdue loan report weekly on Monday at 8:00 AM
     */
        ...
        try {
            ...
            if (!overdueLoans.isEmpty()) {
                ...
                for (LoanResponseDTO loan : overdueLoans) {
                    log.warn("Overdue Loan - Number: {}, Customer: {}, Amount: ₹{}, Days Overdue: {}", 
                            loan.getLoanNumber(), 
