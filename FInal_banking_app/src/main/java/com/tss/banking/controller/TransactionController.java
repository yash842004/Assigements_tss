...
public class TransactionController {
    ...
    @PostMapping("/deposit")
    public ResponseEntity<ApiResponseDTO<TransactionResponseDTO>> deposit(@RequestBody TransactionRequestDTO transactionRequest) {
        try {
    ...
    public ResponseEntity<ApiResponseDTO<TransactionResponseDTO>> withdraw(@RequestBody TransactionRequestDTO transactionRequest) {
        try {
